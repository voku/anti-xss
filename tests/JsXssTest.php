...
class JsXssTest extends TestCase
{
    ...
    public function testFromJsXss(): void
    {
        // 兼容各种奇葩输入
        static::assertSame('', (new AntiXSS())->xss_clean(''));
        // Test null handling - should convert to string
        static::assertSame('', (new AntiXSS())->xss_clean(''));
        ...
        // 过滤不在白名单中的属性
        static::assertSame('<a oo="1" xx="2" title="3">yy</a>',
                           (new AntiXSS())->xss_clean('<a oo="1" xx="2" title="3">yy</a>'));
        ...
        static::assertSame('<a  title="oo">', (new AntiXSS())->xss_clean('<a h= title="oo">'));
        static::assertSame('<a title="(/xss/)">',
                           (new AntiXSS())->xss_clean('<a title="javascript&colon;alert(/xss/)">'));
        ...
        // 畸形属性格式
        static::assertSame('<a target = "_blank" title ="bbb">',
                           (new AntiXSS())->xss_clean('<a target = "_blank" title ="bbb">'));
        static::assertSame('<a target = \'_blank\' title =\'bbb\'>',
                           (new AntiXSS())->xss_clean("<a target = '_blank' title ='bbb'>"));
        static::assertSame('<a >', (new AntiXSS())->xss_clean('<a target=_blank title=bbb>'));
        static::assertSame('<a target = "_blank"  title =  "bbb">',
                           (new AntiXSS())->xss_clean('<a target = "_blank" title =  title =  "bbb">'));
        static::assertSame('<a target = " _blank "  title =  "bbb">',
                           (new AntiXSS())->xss_clean('<a target = " _blank " title =  title =  "bbb">'));
        static::assertSame('<a   title =  "bbb">',
                           (new AntiXSS())->xss_clean('<a target = _blank title =  title =  "bbb">'));
        static::assertSame('<a   title =  "bbb">',
                           (new AntiXSS())->xss_clean('<a target = ' . 0x42 . '_blank' . 0x42 . ' title =  title =  "bbb">'));
        static::assertSame('<img  title="xxx">',
                           (new AntiXSS())->xss_clean('<img width = 100    height     =200 title="xxx">'));
        ...
        static::assertSame('<img  title = \'xxx\'>',
                           (new AntiXSS())->xss_clean('<img width = 100    height     =200 title = \'xxx\'>'));
        static::assertSame('<img  title= "xxx" alt="yyy">',
                           (new AntiXSS())->xss_clean('<img width = 100    height     =200 title= "xxx" no=yes alt="yyy">'));
        static::assertSame('<img  title= "xxx" alt="\'yyy\'">',
                           (new AntiXSS())->xss_clean('<img width = 100    height     =200 title= "xxx" no=yes alt="\'yyy\'">'));
        ...
        static::assertSame('<hr>', (new AntiXSS())->xss_clean('<hr>'));
        // 增加白名单标签及属性
        static::assertSame('<ooxx yy="ok" cc="no">uu</ooxx>',
                           (new AntiXSS())->xss_clean('<ooxx yy="ok" cc="no">uu</ooxx>'));

        static::assertSame('>">\'>',
                           (new AntiXSS())->xss_clean('></SCRIPT>">\'><SCRIPT>alert(String.fromCharCode(88,83,83))</SCRIPT>'));

        static::assertSame(';!--"<XSS>=&{()}', (new AntiXSS())->xss_clean(';!--"<XSS>=&{()}'));

        static::assertSame('', (new AntiXSS())->xss_clean('<SCRIPT SRC=http://ha.ckers.org/xss.js></SCRIPT>'));

        static::assertSame('<IMG SRC="(\'XSS\');">',
                           (new AntiXSS())->xss_clean('<IMG SRC="javascript:alert(\'XSS\');">'));

        static::assertSame('<IMG >', (new AntiXSS())->xss_clean('<IMG SRC=javascript:alert(\'XSS\')>'));

        static::assertSame('<IMG >', (new AntiXSS())->xss_clean('<IMG SRC=JaVaScRiPt:alert(\'XSS\')>'));

        static::assertSame('<IMG >',
                           (new AntiXSS())->xss_clean('<IMG SRC=`javascript:alert("RSnake says, \'XSS\'")`>'));

        static::assertSame('<IMG """>">', (new AntiXSS())->xss_clean('<IMG """><SCRIPT>alert("XSS")</SCRIPT>">'));

        static::assertSame('<IMG >',
                           (new AntiXSS())->xss_clean('<IMG SRC=javascript:alert(String.fromCharCode(88,83,83))>'));

        static::assertSame('<IMG >',
                           (new AntiXSS())->xss_clean('<IMG SRC=&#106;&#97;&#118;&#97;&#115;&#99;&#114;&#105;&#112;&#116;&#58;&#97;&#108;&#101;&#114;&#116;&#40;&#39;&#88;&#83;&#83;&#39;&#41;>'));

        static::assertSame('<IMG >',
                           (new AntiXSS())->xss_clean('<IMG SRC=&#0000106&#0000097&#0000118&#0000097&#0000115&#0000099&#0000114&#0000105&#0000112&#0000116&#0000058&#0000097&#0000108&#0000101&#0000114&#0000116&#0000040&#0000039&#0000088&#0000083&#0000083&#0000039&#0000041>'));

        static::assertSame('<IMG >',
                           (new AntiXSS())->xss_clean('<IMG SRC=&#x6A&#x61&#x76&#x61&#x73&#x63&#x72&#x69&#x70&#x74&#x3A&#x61&#x6C&#x65&#x72&#x74&#x28&#x27&#x58&#x53&#x53&#x27&#x29>'));

        static::assertSame('<IMG SRC="(\'XSS\');">',
                           (new AntiXSS())->xss_clean('<IMG SRC="jav ascript:alert(\'XSS\');">'));
        ...
        static::assertSame('&lt;BODY !#$%&()*~+-_.,:;?@[/|\]^`=alert&#40;"XSS"&#41;&gt;',
                           (new AntiXSS())->xss_clean('<BODY onload!#$%&()*~+-_.,:;?@[/|\]^`=alert("XSS")>'));
        ...
        static::assertSame('&lt;iframe src=http://ha.ckers.org/scriptlet.html <',
                           (new AntiXSS())->xss_clean('<iframe src=http://ha.ckers.org/scriptlet.html <'));
        ...
        static::assertSame('<td background="url(\'(1)\')">',
                           (new AntiXSS())->xss_clean('<td background="url(\'javascript:alert(1)\')">'));

        // 过滤 style
        static::assertSame('<DIV >', (new AntiXSS())->xss_clean('<DIV STYLE="width: \nexpression(alert(1));">'));
        static::assertSame('<DIV >',
                           (new AntiXSS())->xss_clean('<DIV STYLE="width: \n expressionexpression((alert(1));">'));
        // 不正常的url
        ...
        static::assertSame('<a href="mailto:me@ucdok.com">',
                           (new AntiXSS())->xss_clean('<a href="mailto:me@ucdok.com">'));
        ...
        static::assertSame('&lt;!--[if gte IE 4]><![endif]--&gt; END',
                           (new AntiXSS())->xss_clean('<!--[if gte IE 4]><SCRIPT>alert(\'XSS\');</SCRIPT><![endif]--> END'));
        static::assertSame('&lt;!--[if gte IE 4]><![endif]--&gt; END',
                           (new AntiXSS())->xss_clean('<!--[if gte IE 4]><SCRIPT >alert(\'XSS\');</SCRIPT><![endif]--> END'));

        // HTML5新增实体编码 冒号&colon; 换行&NewLine;
        static::assertSame('<a href="(/xss/)">',
                           (new AntiXSS())->xss_clean('<a href="javascript&colon;alert(/xss/)">'));
        static::assertSame('<a href="javascript&colonalert(/xss/)">',
                           (new AntiXSS())->xss_clean('<a href="javascript&colonalert(/xss/)">'));
        ...
        static::assertSame('<a href="(1)">',
                           (new AntiXSS())->xss_clean('<a href="javasc&NewLine;ript&colon;alert(1)">'));
        ...
        static::assertSame('<img src="">',
                           (new AntiXSS())->xss_clean('<img src="data:image/png; base64; ofdkofiodiofl">'));
        static::assertSame('<img src="data:image/png; base64, iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAHElEQVQI12P4//8/w38GIAXDIBKE0DHxgljNBAAO9TXL0Y4OHwAAAABJRU5ErkJggg==">',
                           (new AntiXSS())->xss_clean('<img src="data:image/png; base64, iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAHElEQVQI12P4//8/w38GIAXDIBKE0DHxgljNBAAO9TXL0Y4OHwAAAABJRU5ErkJggg==">'));
        static::assertSame('<img src="   PHN2ZyB4bWxuczpzdmc9Imh0dH A6Ly93d3cudzMub3JnLzIwMDAvc3ZnIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcv MjAwMC9zdmciIHhtbG5zOnhsaW5rPSJodHRwOi8vd3d3LnczLm9yZy8xOTk5L3hs aW5rIiB2ZXJzaW9uPSIxLjAiIHg9IjAiIHk9IjAiIHdpZHRoPSIxOTQiIGhlaWdodD0iMjAw IiBpZD0ieHNzIj48c2NyaXB0IHR5cGU9InRleHQvZWNtYXNjcmlwdCI+YWxlcnQoIlh TUyIpOzwvc2NyaXB0Pjwvc3ZnPg==">',
                           (new AntiXSS())->xss_clean('<img src="data:image/svg+xml  ;   base64  ,   PHN2ZyB4bWxuczpzdmc9Imh0dH A6Ly93d3cudzMub3JnLzIwMDAvc3ZnIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcv MjAwMC9zdmciIHhtbG5zOnhsaW5rPSJodHRwOi8vd3d3LnczLm9yZy8xOTk5L3hs aW5rIiB2ZXJzaW9uPSIxLjAiIHg9IjAiIHk9IjAiIHdpZHRoPSIxOTQiIGhlaWdodD0iMjAw IiBpZD0ieHNzIj48c2NyaXB0IHR5cGU9InRleHQvZWNtYXNjcmlwdCI+YWxlcnQoIlh TUyIpOzwvc2NyaXB0Pjwvc3ZnPg==">'));

        static::assertSame('<img src="PHNjcmlwdD5hbGVydCgnWFNTJyk8L3NjcmlwdD4K">',
                           (new AntiXSS())->xss_clean('<img src="data:text/html;base64,PHNjcmlwdD5hbGVydCgnWFNTJyk8L3NjcmlwdD4K">'));

        // HTML备注处理
        static::assertSame('&lt;!--                               --&gt;',
                           (new AntiXSS())->xss_clean('<!--                               -->'));
