...
class XssTest extends TestCase
{
    ...
    public function testNoXssUrlWithJson(): void
    {
        $testArray = [
...
xmlns:x="http://www.w3.org/1999/xhtml ">alert(1&#00000041;', // IE11
            ...
            '<style><img src="</style><img src=x onerror=alert(1)//">'                                                                                                                                                                  => '&lt;style&gt;<img src="&lt;/style&gt;&lt;img ">',
            '<head><base href="javascript://"/></head><body><a href="/. /,alert(1)//#">XXX</a></body>'                                                                                                                                  => '&lt;head&gt;&lt;base href="//"/&gt;&lt;/head&gt;&lt;body&gt;<a href="/. /,alert&#40;1&#41;//#">XXX</a>&lt;/body&gt;',
...
textContent>click me!',
    ...
    public function testHtmlNoXssPerformance()
    {
        $input = 'Modul <b>01 . Titel / Intro</b> kann nicht gelöscht werden, da es noch von folgenden Artikeln genutzt wird:
        <ul>
          <li><a href="index.php?page=content&amp;article_id=2&amp;clang=1&amp;ctype=1">Struktur [2] [de]</a></li>
          <li><a href="index.php?page=content&amp;article_id=2&amp;clang=2&amp;ctype=1">Structure [2] [en]</a></li>
          <li><a href="index.php?page=content&amp;article_id=3&amp;clang=1&amp;ctype=1">Templates [3] [de]</a></li>
          <li><a href="index.php?page=content&amp;article_id=3&amp;clang=2&amp;ctype=1">Templates [3] [en]</a></li>
          <li><a href="index.php?page=content&amp;article_id=4&amp;clang=1&amp;ctype=1">Module [4] [de]</a></li>
          <li><a href="index.php?page=content&amp;article_id=4&amp;clang=2&amp;ctype=1">Modules [4] [en]</a></li><li><a href="index.php?page=content&amp;article_id=13&amp;clang=1&amp;ctype=1">Fehlerseite [13] [de]</a></li>
          <li><a href="index.php?page=content&amp;article_id=13&amp;clang=2&amp;ctype=1">Error page [13] [en]</a></li>
          <li><a href="index.php?page=content&amp;article_id=15&amp;clang=1&amp;ctype=1">Sprachen [15] [de]</a></li>
          <li><a href="index.php?page=content&amp;article_id=15&amp;clang=2&amp;ctype=1">Languages [15] [en]</a></li></ul>
        ';

        for ($i = 0; $i < 2; ++$i) { // keep this loop, for quick performance tests
            static::assertSame($input, (new AntiXSS())->xss_clean($input), 'testing: ' . $input);
        }
    }
...
HTML;
        ...
        $antiXss = new AntiXSS();
        $antiXss->removeEvilHtmlTags(['video', 'source']);
        static::assertSame($html, $antiXss->xss_clean($html));
        static::assertSame(false, $antiXss->isXssFound());
    }
    ...
    public function testSvgXssFileV1(): void
    {
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/YE7VzlLtp-4?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
    ...
    public function testNonXssFile(): void
    {
    ...
    public function testNonXssBigFile(): void
    {
    ...
    public function testPerformanceIssue(): void
    {
    ...
    public function testUrls(): void
    {
        ...
        foreach ($testArray as $before => $after) {
            XssTest::assertSame($after, (new AntiXSS())->xss_clean($before), 'testing: ' . $before);
        }
    }
    ...
    public function testJavaScriptCleaning()
    {
        ...
        static::assertSame('<img src="&lt;?php echo ">" alt="bar" title="foo">', (new AntiXSS())->xss_clean($testString));

        $testString = '<img src="<?php echo "http://moelleken.org/test.png" ?>" alt="bar" title="javascript:alert(\'XSS\');">';
        static::assertSame('<img src="&lt;?php echo ">" alt="bar" title="(\'XSS\');">', (new AntiXSS())->xss_clean($testString));
    ...
    public function testXssCleanJsImgRemoval(): void
    {
    ...
    public function testXssCleanJsDivRemoval(): void
    {
