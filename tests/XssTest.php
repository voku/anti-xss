  ...
  // INFO: here you can find some more tests
    ...
    public function testXssClean()
    {
      ...
      <>" >', // autofocus trick | https://html5sec.org/#7
            ...
            '")}alert(/XSS/);{//'                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       => '")}alert&#40;/XSS/&#41;;{//',
            '<svgonload=alert(1)>'                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      => '&lt;svg=alert&#40;1&#41;&gt;', // 2015: https://twitter.com/ret2libc/status/635923671681507328
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/YE7VzlLtp-4?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
    ...
    public function testScriptEncoding()
    {
        ...
        $testArray = [
            ...
            "'`\"><\x3Cscript>javascript:alert(1)</script>'`\"><\x00script>javascript:alert(1)</script>" => "'`\">&lt;alert&#40;1&#41;'`\"&gt;&lt; script>alert&#40;1&#41;",
        ];
    ...
    public function testXssCleanSanitizeNaughtyHtmlAttributes()
    {
        ...
        static::assertSame('<foo prefix="bar">', $this->antiXss->xss_clean('<foo prefixOnAttribute="bar">'));
        ...
        static::assertSame('<img src="x"> on=\'x\' on=error=``,alert&#40;1&#41;>', $this->antiXss->xss_clean('<img src="x"> on=\'x\' ononerror=error=``,alert(1)>'));
