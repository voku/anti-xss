...
final class AntiXSS
{
     ...
     */
    private const CSS_ESCAPED_EXPRESSION_REGEX = '(?>e|\\\\0{0,5}(?:45|65)\s?)(?>x|\\\\0{0,5}(?:58|78)\s?)(?>p|\\\\0{0,5}(?:50|70)\s?)(?>r|\\\\0{0,5}(?:52|72)\s?)(?>e|\\\\0{0,5}(?:45|65)\s?)(?>s|\\\\0{0,5}(?:53|73)\s?)(?>s|\\\\0{0,5}(?:53|73)\s?)(?>i|\\\\0{0,5}(?:49|69)\s?)(?>o|\\\\0{0,5}(?:4f|6f)\s?)(?>n|\\\\0{0,5}(?:4e|6e)\s?)\s*(?:\(|&\#40;)';
