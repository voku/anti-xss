            ...
            if (!$replace_single_chars_only) {
                ...
                if ($maxKeyLength >= 4) {
                    foreach ($matches[0] as $keyTmp => $char) {
                        ...
                        if (
                            ...
                            $str                  = \str_replace($fourChars,
                                                                 $REPLACE_HELPER_CACHE[$cacheKey][$fourChars], $str);
                ...
                foreach ($matches[0] as $keyTmp => $char) {
                    ...
                    if (
                        ...
                        $str                   = \str_replace($threeChars,
                                                              $REPLACE_HELPER_CACHE[$cacheKey][$threeChars], $str);
                ...
                foreach ($matches[0] as $keyTmp => $char) {
                    ...
                    if (
                        ...
                        $str                 = \str_replace($twoChars, $REPLACE_HELPER_CACHE[$cacheKey][$twoChars],
                                                            $str);
